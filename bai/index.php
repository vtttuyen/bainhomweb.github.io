        ...
        <div class = "nav">
            ...
            <div class = "responsive">
                <ul class = "nav-menu" id = "nav-menu">
                    ...
                    <li><a href = "home.php?page=products">Our Food</a></li>
    ...
    <div class = "container-fluid">
        <div class = "row">
            ...
            <div class = "col-md-8 text-center">
                ...
                <a href = "home.php?page=product&id=<?=$hotdeal[0]['id']?>" class = "btn-common-white page-scroll">Order Now</a>
            </div>
            <div class = "col-md-2"></div>
        </div>
    </div>
            ...
            <div class = "col-md-12">
                <div class = "chefs_wrap_slider">
                    <div class = "owl-carousel" id = "chef">
                        ...
                        <div class = "item">
                            <div class = "chef_wrap">
                                <img src = "images/34113.jpg">
                                <h3>Hồ Thị Kim Anh</h3>
                        ...
                        <div class = "item">
                            <div class = "chef_wrap">
                                <img src = "images/PreEmploymentStudent_2020_1.jpg">
                                <h3>Adam</h3>
                                <small>Co-Head Cook</small>
                                <p>Enjoy Delicious Food</p>
                            </div>
                        ...
                        <form onSubmit = "return false" id = "order_form" class = "callus">
                            ...
                            <div class = "row">
                                ...
                                <div class = "col-md-12">
                                    ...
                                    <div class = "form-group">
                                        <input class = "btn-submit" type = "submit" value = "Place Booking" id = "btn_order_submit">
                                    </div>
                                </div>
                            </div>
                        </form>
